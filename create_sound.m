...
function [sound_out] = create_sound(instrument,freq,constants)
...
switch instrument.sound
    ...
    case {'Subtractive'}
        ...
        for i = 1:num
            ...
            sound_out(index) = filter(1, a, sq(index)); % filter small segments at a time
    ...
    case {'FM'}
        ...
        sound_out = sin( (2 * pi * fund * t) + f_mod );

        sound_out = sound_out .* envelope1;
